...
export default function LandingPage() {
  ...
  return (
    <div className="landing-page" style={{ minHeight: '100vh', background: '#000000', color: '#ffffff', fontFamily: 'var(--font-body)', position: 'relative', overflowX: 'hidden' }}>
      ...
      {/* 2. SLIDE 1: HERO SECTION (Scrolls up into view) */}
      <section style={{
        maxWidth: '1200px',
        margin: '0 auto',
        ...
        {/* Hero Title with staggered slide-in */}
        <div className="scroll-reveal scroll-reveal-up is-visible">
          <h1 style={{
        ...
        {/* Hero Description */}
        <div className="scroll-reveal scroll-reveal-up delay-100 is-visible">
          <p style={{
            color: '#94a3b8',
            fontSize: '18px',
            maxWidth: '580px',
        ...
        {/* CTA Buttons */}
        <div className="scroll-reveal scroll-reveal-up delay-200 is-visible" style={{ display: 'flex', gap: '16px', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
          <Link href="/auth?mode=signup" style={{ textDecoration: 'none' }}>
            <button 
        ...
        <div className="scroll-reveal scroll-reveal-up delay-300 is-visible" style={{ marginTop: '70px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', opacity: 0.6 }}>
      ...
      {/* ========================================================================= */}
      <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '80px 32px 120px 32px', position: 'relative' }}>
        <div className="scroll-reveal scroll-reveal-left glass-card" style={{
          padding: '48px',
          borderRadius: '16px',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 340px), 1fr))', gap: '40px', alignItems: 'center' }}>
            ...
            {/* Right Visual Card Stack (Slides in with staggered delay) */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div className="scroll-reveal scroll-reveal-up delay-100" style={{
              ...
              <div className="scroll-reveal scroll-reveal-up delay-200" style={{
                background: 'rgba(0,0,0,0.6)',
              ...
              <div className="scroll-reveal scroll-reveal-up delay-300" style={{
                background: 'rgba(0,0,0,0.6)',
      ...
      {/* ========================================================================= */}
      <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '80px 32px 120px 32px', position: 'relative' }}>
        <div className="scroll-reveal scroll-reveal-right glass-card" style={{
          padding: '48px',
          borderRadius: '16px',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 340px), 1fr))', gap: '40px', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {[
                ...
                <div key={i} className="scroll-reveal scroll-reveal-up" style={{ transitionDelay: `${0.1 * (i + 1)}s` }}>
      ...
      <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '80px 32px 120px 32px', position: 'relative' }}>
        <div className="scroll-reveal scroll-reveal-left glass-card" style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
            ...
            <div className="scroll-reveal scroll-reveal-up delay-100 glass-card" style={{
              padding: '28px',
              borderRadius: '12px',
            ...
            {/* Directive 2: STOP */}
            <div className="scroll-reveal scroll-reveal-up delay-200 glass-card" style={{
              padding: '28px',
              borderRadius: '12px',
            ...
            {/* Directive 3: CREATE */}
            <div className="scroll-reveal scroll-reveal-up delay-300 glass-card" style={{
              padding: '28px',
              borderRadius: '12px',
      ...
      <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '80px 32px 120px 32px', position: 'relative' }}>
        <div className="scroll-reveal scroll-reveal-right glass-card" style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 340px), 1fr))', gap: '40px', alignItems: 'center' }}>
            ...
            <div className="scroll-reveal scroll-reveal-scale delay-100" style={{
      ...
      <section style={{
        ...
        <div className="scroll-reveal scroll-reveal-scale glass-card" style={{
          padding: '64px 32px',
          borderRadius: '20px',
